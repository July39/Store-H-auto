...
#define SPIN_DELAY   2500

#ifdef ESP12E
#define SERVO_PIN      15   // D6
#define PHOTOCELL_PIN  A0   // Frank 10 == SD3
/** Pin definitions */
#else
#define SERVO_PIN      2
 ...
 *        le store se ferme le soir, et ouvre le jour (Defaut)  
 * 
 * @return true 
 * @return false 
 */
